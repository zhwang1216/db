...
import com.zhwang.drug.dao.DrugCategoryDao;
...
public class DrugCategoryServiceImpl implements IDrugCategoryService {
	 ...
	 */
	@Override
	public void addDrugCategory(DrugCategory drugCategory) throws CategoryNameDuplicateException, InsertException {
		String categoryName = drugCategory.getCategoryName();
		DrugCategory resultCategoryName = findByCategoryName(categoryName);
		if( resultCategoryName != null ) {
			throw new CategoryNameDuplicateException("你添加的药品类别（"+categoryName+"）已经被使用");
		}
